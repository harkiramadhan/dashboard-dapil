...
<body>
  <div class="page-wrapper">
    <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="side-navigation w-nav no-print">
      <div class="navside-container">
        <a href="<?= base_url('') ?>" class="nav-brand w-nav-brand">
        ...
        <nav role="navigation" class="sidenav-menu w-nav-menu">
          ...
          <div class="margin-top-120">
            <div class="sidenav-menu-flex">
              ...
              <a href="#" class="download-button w-inline-block" download>
    ...
    <div class="page-content">
      ...
      <section class="section no-padding wf-section no-print">
        <div class="container">
            ...
            <div class="margin-24">
              <div class="flex-horizontal-between">
                ...
                <div class="button-wrapper">
                  <a href="#" class="download-button w-inline-block"  id="downloadPdf" style="display: none">
      ...
      <div id="reportPage" style="background-color: white">
        <section class="section no-padding wf-section">
          <div class="container">
            <div class="content-wrapper foto" style="display: none">
      ...
      <div class="footer wf-section no-print"></div>
